...
module.exports = (Dependency) => {
  ...
  class Copacetic extends EventEmitter {
     ...
     * @typedef {Object} Copacetic~HealthReport
     * @property {Boolean} isHealthy The result of `isHealthy()`
     * @property {String} Name
     * @property {Array[DependencyHealth]} dependencies The result of `healthInfo()`
     */
    get healthReport () {
      return {
        name: this.name,
